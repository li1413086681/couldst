<template>
	<div class="container" style="width: 100%;">
		<top></top>
		<search></search>
		<div style="background-image: url(../../static/imgs/IMG20190905_171924.jpg); width: 100%;height: 600px;background-size: 100%;">
...
<script>
	...
	export default{
		...
		methods:{
			insertorder(){
				var ob=this;
				var url="http://127.0.0.1:8087/mgj/mgj/insertorder";
				$.ajax(url,{
