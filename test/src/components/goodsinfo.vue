			...
			<div id="left_2">
				...
				<div id="left_2_7" style="margin: 40px 0px;">
					...
					<p style="display:inline;">
						<img src="../../static/imgs/180417_25kbfg1c3hdbd120394ji4b11.png" style="height:30px ;"/>72小时发货&nbsp;
						<img src="../../static/imgs/180417_25kbfg1c3hdbd120394ji4b11.png" style="height:30px ;"/>7天无理由退款 &nbsp;
						<img src="../../static/imgs/180417_25kbfg1c3hdbd120394ji4b11.png" style="height:30px ;"/>延误必配&nbsp;
						<img src="../../static/imgs/180417_25kbfg1c3hdbd120394ji4b11.png" style="height:30px ;"/>退货补运费&nbsp;
					</p>
				</div>
				<div id="left_2_8" style="margin: 30px 0px;">
					<span>支付方式：</span><p style="display: inline"><img src="../../static/imgs/pay.png"/>&nbsp;&nbsp;&nbsp;<img src="../../static/imgs/wechat.png"/></p>
				</div>
			</div>
...
<script>
	...
	export default{
		...
		methods:{
			...
			getimage(){
				var ob=this;
				var url="http://127.0.0.1:8087/mgj/mgj/getgoodsinfobygdid";
				$.ajax(url,{
			...
			insertcart(){
				...
				if(!ob.session){
					...
					if(window.confirm("是否加入购物车？")){
						var url="http://127.0.0.1:8087/mgj/mgj/insertcart";
						$.ajax(url,{
							xhrFields: {"withCredentials": true},
							data:{
								"gdid":ob.gdid,
		...
		mounted(){
			...
			var url="http://127.0.0.1:8087/mgj/mgj/getgoodssizeforajax";
			$.ajax(url,{
				xhrFields: {"withCredentials": true},
				dataType:"json",
				async:false,
