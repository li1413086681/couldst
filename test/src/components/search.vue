<template>
	<div :style="remove1" id="search1" style="width: 1600px;z-index: 10;background-color: white;" class="container" >
		<div style="float: left;width: 20%;text-align: center;" >
			<img src="../../static/imgs/190102_088f4i166l4gkl08k297h5kk8.png" style="height: 130px;width: 190px;"/>
		</div>
	...
	export default{
		data:function(){
			return{
				...
				index_1:-1,
				images:[
					"background-image:url(../../static/imgs/0b7a0e038d0e4133fc22a28a7d06_640_832.cg.jpg)",
					"background-image:url(../../static/imgs/0ed17bd8e90023fdb29a836a7e8b_640_919.cj.jpg)",
					"background-image:url(../../static/imgs/2c739855b49ef68b8ded88aef13c_640_832.cj.jpg)"
				],
				imagee:"background-image:url(../../static/imgs/0b7a0e038d0e4133fc22a28a7d06_640_832.cg.jpg)",
				num:0,
				remove1:[],
				user_1:[]
			}
		...
		methods:{
			...
			getgoodsinfo(){
				var ob=this;
				var url="http://127.0.0.1:8087/mgj/mgj/getgoodsinfogdname";
				$.ajax(url,{
